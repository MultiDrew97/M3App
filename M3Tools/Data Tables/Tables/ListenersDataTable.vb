Namespace DataTables
	Public Class ListenersDataTable
		Inherits TypedTableBase(Of Rows.ListenersDataRow)

		Public Delegate Sub ListenersDataRowChangeEventHandler(ByVal sender As Object, ByVal e As Events.ListenersRowChangeEvent)
		...
		Default Public ReadOnly Property Item(ByVal index As Integer) As Rows.ListenersDataRow
			Get
				Return CType(Me.Rows(index), Rows.ListenersDataRow)
			End Get
		End Property
		...
		Public Sub AddEmailListenersRow(ByVal row As Rows.ListenersDataRow)
			AddEmailListenersRow(CInt(row("ListenerID")), CStr(row("Name")), CStr(row("EmailAddress")))
		End Sub

		Public Function AddEmailListenersRow(ListenerID As Integer, Name As String, EmailAddress As String) As Rows.ListenersDataRow
			Dim ListenersDataRow As Rows.ListenersDataRow = CType(Me.NewRow, Rows.ListenersDataRow)
			ListenersDataRow.ItemArray = {ListenerID, Name, EmailAddress}
			Me.Rows.Add(ListenersDataRow)
			Return ListenersDataRow
		End Function

		Public Function FindByID(ByVal ID As Integer) As Rows.ListenersDataRow
			Return CType(Me.Rows.Find(New Object() {ID}), Rows.ListenersDataRow)
		End Function
		...
		Public Function NewListenersDataRow() As Rows.ListenersDataRow
			Return CType(Me.NewRow, Rows.ListenersDataRow)
		End Function

		Protected Overrides Function NewRowFromBuilder(builder As DataRowBuilder) As DataRow
			Return New Rows.ListenersDataRow(builder)
		End Function

		Protected Overrides Function GetRowType() As Global.System.Type
			Return GetType(Rows.ListenersDataRow)
		End Function

		Protected Overrides Sub OnRowChanged(ByVal e As DataRowChangeEventArgs)
			MyBase.OnRowChanged(e)
			If ((Me.ListenersDataRowChangedEvent) IsNot Nothing) Then
				RaiseEvent ListenersDataRowChanged(Me, New Events.ListenersRowChangeEvent(CType(e.Row, Rows.ListenersDataRow), e.Action))
			End If
		End Sub
		...
		Protected Overrides Sub OnRowChanging(ByVal e As Global.System.Data.DataRowChangeEventArgs)
			...
			If ((Me.ListenersDataRowChangingEvent) IsNot Nothing) Then
				RaiseEvent ListenersDataRowChanging(Me, New Events.ListenersRowChangeEvent(CType(e.Row, Rows.ListenersDataRow), e.Action))
			End If
		End Sub
		...
		Protected Overrides Sub OnRowDeleted(ByVal e As Global.System.Data.DataRowChangeEventArgs)
			...
			If ((Me.ListenersDataRowDeletedEvent) IsNot Nothing) Then
				RaiseEvent ListenersDataRowDeleted(Me, New Events.ListenersRowChangeEvent(CType(e.Row, Rows.ListenersDataRow), e.Action))
			End If
		End Sub
		...
		Protected Overrides Sub OnRowDeleting(ByVal e As Global.System.Data.DataRowChangeEventArgs)
			...
			If ((Me.ListenersDataRowDeletingEvent) IsNot Nothing) Then
				RaiseEvent ListenersDataRowDeleting(Me, New Events.ListenersRowChangeEvent(CType(e.Row, Rows.ListenersDataRow), e.Action))
			End If
		End Sub

		Public Sub RemoveEmailListenersRow(ByVal row As Rows.ListenersDataRow)
			Me.Rows.Remove(row)
		End Sub
