Namespace DataTables
	...
	Public Class OrdersDataTable
		Inherits TypedTableBase(Of Rows.OrdersDataRow)

		Public Delegate Sub OrdersDataRowChangeEventHandler(ByVal sender As Object, ByVal e As Events.OrdersRowChangeEvent)
		...
		Default Public ReadOnly Property Item(ByVal index As Integer) As Rows.OrdersDataRow
			Get
				Return CType(Me.Rows(index), Rows.OrdersDataRow)
			End Get
		End Property
		...
		Public Function FindByID(ByVal ID As Integer) As Rows.OrdersDataRow
			Return CType(Me.Rows.Find(New Object() {ID}), Rows.OrdersDataRow)
		End Function
		...
		Public Function NewOrdersDataRow() As Rows.OrdersDataRow
			Return CType(Me.NewRow, Rows.OrdersDataRow)
		End Function

		Protected Overrides Function NewRowFromBuilder(builder As DataRowBuilder) As DataRow
			Return New Rows.OrdersDataRow(builder)
		End Function

		Protected Overrides Function GetRowType() As Global.System.Type
			Return GetType(Rows.OrdersDataRow)
		End Function

		Protected Overrides Sub OnRowChanged(ByVal e As DataRowChangeEventArgs)
			MyBase.OnRowChanged(e)
			If ((Me.OrdersDataRowChangedEvent) IsNot Nothing) Then
				RaiseEvent OrdersDataRowChanged(Me, New Events.OrdersRowChangeEvent(CType(e.Row, Rows.OrdersDataRow), e.Action))
			End If
		End Sub
		...
		Protected Overrides Sub OnRowChanging(ByVal e As Global.System.Data.DataRowChangeEventArgs)
			...
			If ((Me.OrdersDataRowChangingEvent) IsNot Nothing) Then
				RaiseEvent OrdersDataRowChanging(Me, New Events.OrdersRowChangeEvent(CType(e.Row, Rows.OrdersDataRow), e.Action))
			End If
		End Sub
		...
		Protected Overrides Sub OnRowDeleted(ByVal e As Global.System.Data.DataRowChangeEventArgs)
			...
			If ((Me.OrdersDataRowDeletedEvent) IsNot Nothing) Then
				RaiseEvent OrdersDataRowDeleted(Me, New Events.OrdersRowChangeEvent(CType(e.Row, Rows.OrdersDataRow), e.Action))
			End If
		End Sub
		...
		Protected Overrides Sub OnRowDeleting(ByVal e As Global.System.Data.DataRowChangeEventArgs)
			...
			If ((Me.OrdersDataRowDeletingEvent) IsNot Nothing) Then
				RaiseEvent OrdersDataRowDeleting(Me, New Events.OrdersRowChangeEvent(CType(e.Row, Rows.OrdersDataRow), e.Action))
			End If
		End Sub

		Public Sub RemoveOrdersRow(ByVal row As Rows.OrdersDataRow)
			Me.Rows.Remove(row)
		End Sub
