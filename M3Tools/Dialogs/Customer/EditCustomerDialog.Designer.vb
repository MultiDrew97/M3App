Namespace Dialogs
	...
	Partial Class EditCustomerDialog
		...
		Private Sub InitializeComponent()
			...
			Me.bw_LoadCustomer = New System.ComponentModel.BackgroundWorker()
			...
			Me.gi_Email.UseSystemPasswordChar = False
			'
			'af_Address
			'
		...
		Friend WithEvents bw_LoadCustomer As ComponentModel.BackgroundWorker
