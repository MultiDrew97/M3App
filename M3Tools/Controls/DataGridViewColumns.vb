...
Public MustInherit Class DataGridViewImageButtonColumn
	...
	Protected Sub New(cellTemplate As Type)
		Console.WriteLine(cellTemplate)
		Me.CellTemplate = CType(cellTemplate.GetConstructor({GetType(Drawing.Bitmap)}).Invoke({ButtonImage}), DataGridViewCell)
		Width = 22
...
Public Class DataGridViewImageButtonDeleteColumn
	...
	Public Sub New()
		MyBase.New(GetType(DataGridViewImageButtonDeleteCell))
	End Sub
End Class
...
Public Class DataGridViewImageButtonEditColumn
	...
	Public Sub New()
		MyBase.New(GetType(DataGridViewImageButtonEditCell))
	End Sub
End Class
...
Public Class DataGridViewImageButtonEditCell
	...
	Public Sub New(Optional image As Drawing.Bitmap = Nothing)
		MyBase.New(If(image, My.Resources.edit))
	End Sub
...
Public Class DataGridViewImageButtonDeleteCell
	...
	Public Sub New(Optional image As Drawing.Bitmap = Nothing)
		MyBase.New(If(image, My.Resources.delete))
	End Sub
