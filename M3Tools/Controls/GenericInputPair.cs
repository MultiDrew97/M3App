...
namespace SPPBC.M3Tools
{
	...
	public partial class GenericInputPair
	{
		...
		/// </summary>
		public int TextLength => txt_Input.TextLength;
		...
		{
			get => txt_Input.UseSystemPasswordChar;
			set => txt_Input.UseSystemPasswordChar = value;
		}
		...
		{
			get => txt_Input.Text != Placeholder ? txt_Input.Text : "";
			set
			{
		...
		{
			get => txt_Input.ReadOnly;
			set => txt_Input.ReadOnly = value;
		}
