...
Public Class CustomEmail
	...
	Private Sub BoldText(sender As Object, e As EventArgs) Handles btn_Bold.Click
	...
	Private Sub UnderlineText(sender As Object, e As EventArgs) Handles btn_Underline.Click
		Dim fontStyle = GetCurrentFontStyle()
	...
	Private Sub ItalicizeText(sender As Object, e As EventArgs) Handles btn_Italics.Click
		Dim fontStyle = GetCurrentFontStyle()
