...
namespace M3App
{
    ...
    public partial class CreateFolderDialog : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            dt_DriveHeirarchy.DataBindings.Add(new Binding("Username", global::M3App.Settings.Default, "Username", true, DataSourceUpdateMode.OnPropertyChanged));
            ...
            dt_DriveHeirarchy.Username = global::M3App.Settings.Default.Username;
