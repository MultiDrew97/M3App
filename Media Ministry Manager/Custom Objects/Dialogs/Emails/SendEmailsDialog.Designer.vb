...
Partial Class SendEmailsDialog
    ...
    Private Sub InitializeComponent()
        ...
        Me.gd_Uploader = New SPPBC.M3Tools.GTools.GdriveTool(Me.components)
        ...
        'gd_Uploader
        '
        Me.gd_Uploader.Username = Nothing
        '
        'SendEmailsDialog
        '
    ...
    Friend WithEvents gd_Uploader As SPPBC.M3Tools.GTools.GdriveTool
End Class
